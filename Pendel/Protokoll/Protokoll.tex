...
$l_1$ und $l_2$ sind Strecken die gut mit der Schiebleere gemessen werden können, da man diese gut ansetzen kann. 
...
Zur Messung des Durchmessers, haben wir das Pendel vom Winkelaufnehmer genommen und mit der Schwiblehre den Durchmesser gemessen.
...
Durch die Messung mit der Schiblehre wussten wir, dass der Mittelpunkt 4.040cm unter der oberen Kante war.
...
Im nachhinein ist uns aufgeallen, dass dies keine sehr geschickte wahl war, da wir eh den Radius des Pendelkörpers mit der Schiebleere bestimmt haben.
Eine höhere Genauigkeit hätten wir erziehlen können, wenn wir nur bis zu der Oberseite des Pendels gemessen hätten. 
...
$l_1$ bezeichnet den Abschnitt zwischen dem Boden des U-Profils und der ersten Einkerbung der Pendelaufhängung.
$l_2$ ist der Abstand zwischen der Ersten Einkerbung bis zum Mittelpunkt des Pendelkörpers.\\ 

Da dad U-Profil zwei Nadeln hat, haben wir von jeder jewails den abstand zum Boden gemssen. 
...
Die Systematischen Fehler können den Herstellerangamen entnommen werden für die Schiebleere und für das Maßband.
...
Hier können wir gut erkennen, dass die Schwingung einem Kosinusförmigen verlauf hat.  
Sie hat eine Amplitude von ca 0.35 Volt. 
Die in der Graphik angezeigte nullinie, wird nicht genau null sein, da es nicht möglich war den Winkelaufnehmer perfekt zu nullen.
Die leichten unregelmäßigkeiten in der Kurve stammen daher, dass wir nur diskrete Messpunkte haben. 

\begin{figure}[H]
    \centering
    \subfloat{\includegraphics[width=0.45\textwidth]{plots/stange-2-komplett.PNG}}
    \hfill
    \subfloat{\includegraphics[width=0.45\textwidth]{plots/stange-2-mehrere-schwingungeng.PNG}}
...
Hier ist ein größerer Ausschnitt zu sehen. Hier kann man erkennen, dass die Schwingung auch Kosinusförmig verläuft. 
Beim betrachten der Gesamten Schwingung in CASSY konnten wir sehen, dass dieser Kosinus färmige verlauf die gesamte Messung über beibehalten wird.
...
\begin{figure}[H]
    \centering
    \subfloat{\includegraphics[width=0.45\textwidth]{plots/stange-3-mehrere-schwingungeng.PNG}}
    \hfill
    \subfloat{\includegraphics[width=0.45\textwidth]{plots/stange-3-maximum.PNG}}
...
Wärend den Messungen haben wir damit wir die Periodendauer überschlagen können, bei CASSY mit dem Peakschwerpunkt das erste und das zwanzigste Maximum bestimmt.
...
\begin{figure}[H]
    \centering
    \subfloat{\includegraphics[width=0.4\textwidth]{plots/gewicht-1-mehrere-schwingungen.PNG}}
    \hfill
    \subfloat{\includegraphics[width=0.55\textwidth]{plots/gewicht-1-peak-schnell.PNG}}
    \caption{Ausschnitt des Schwingungsverlauf der ersten Messung mit Pendelkörper}
    \end{figure}

Auch hier können wir erkennen, dass die Schwingung einem Kosinusförmigen Verlauf folgt.
...
Für die Weiteren Messungen sid hir auch die Schwingungsverläufe Dargestellt.
Für jede Messung der komplette Schwingungsverlauf und ein Ausschnitt der Schwingung. 

\begin{figure}[H]
    \centering
    \subfloat{\includegraphics[width=0.55\textwidth]{plots/gewicht-2-komplett.PNG}}
    \hfill
    \subfloat{\includegraphics[width=0.40\textwidth]{plots/gewicht-2-schwungungen.PNG}}
    \caption{Schwingungsverlauf der zweiten Messung mit Pendelkörper}
    \end{figure}
 
\begin{figure}[H]
    \centering
    \subfloat{\includegraphics[width=0.55\textwidth]{plots/gewicht-3-komplett.PNG}}
    \hfill
    \subfloat{\includegraphics[width=0.40\textwidth]{plots/gewicht-3-schwungungen.PNG}}
    \caption{Schwingungsverlauf der dritten Messung mit Pendelkörper}
    \end{figure}

Zuletzt ist hier noch eine Nahaufnahme eines Maximas gezeigt, in dieser kann man erkennen, dass die Messpunkte um das Maxima nicht perfekt Kosinunsförmig sind.
