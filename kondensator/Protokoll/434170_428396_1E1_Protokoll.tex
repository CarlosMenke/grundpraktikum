...
Hier ist eine Exemplarische darstellung unserer Messungen.
Wie man sehen kann, sind sowohl die Spannung wie die Stromstäke normalverteilt.
  \begin{figure}[H]
      \centering
      \includegraphics[width=0.7\textwidth]{plots/messung-wiederstand-07.pdf}
      \caption{Verteilung der gemessenen Spannung und Stromstärke}
  \end{figure}
Die Statistischen Fehler haben wir mittels Erwartungswert und Varianz auf die Spannung und die stromstärke berechnet.
\end{aufgabe}
...
In diesem Versuch soll sowohl Spannung als auch Strom am Wiederstand gemessen werden. Das schaltbild für diese Messung können sie in der folgenden Skizze sehen. \\
  ...
  \begin{figure}[H]
  \centering
  \includegraphics[width=0.5\textwidth]{Schaltung_R_Cassy.pdf}
...
Bei unserer Ersten Testmessung hatten wir ein zu großes Stromintervall gewählt, weshalb der Digitalisierungsfehler die Messung unauswertbar gemacht hat. Deshalb haben wir das kleinste Intervall für den Strom verwendet. 
 ...
 Zunächst haben wir eine Testmessung gemacht, ob wir ein Signal erhalten. Diese konnten wir auch verwenden um unsere Messzeit sinnvoll ein zu stellen. 
 ...
 Desweiteren wissen wir, dass der Statistischen Fehler mit $ \bar{\sigma} = \frac{\sigma}{\sqrt{N}}$ bestimmt wirt. Dabei ist $\sigma$ die Standardabweichung zu der Verteilung unserer Messdaten. Diese können wir mit CASSY mit einem Gauß fit grob bestimmen. 
 Und verwenden um ein mindestwert für unsere Messwertanzahl N zu berechnen. Dabei fordern wir $\sigma_D > \bar{\sigma}$ Daraus konnten wir die mindestanzahl von Messpunkten die wir benötigen auf ca. 500 bestimmen. 
...
Wir haben uns entschieden Einstellungen zu verwenden, die wir Problemlos auch für die Messung der Entladung des Kondensators verwenden können. Weswegen wir die Messzeit auf ca. zehn $\tau$ gewählt haben. 

Nachdem wir alle Einstellungen im CASSY vorgenommen hatten, starteten wir eine Testmessung. Bei dieser konnten wir erkennen, dass die Spannung und der Strom um einen Wert fluktuiert. 
