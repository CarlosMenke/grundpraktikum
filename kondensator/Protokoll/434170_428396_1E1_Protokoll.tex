...
Da diese um 2 Werte geschwankt sind, haben wir den Mittelwert genommen.
...
% TODO offset notiren in tabelle
...
Dabei haben wir darauf geachtet, das der Anfangsmesspunkt mindestens $ \frac{1}{20} \tau $ nach dem Entlade beginn liegt.
Da wir ein sehr großes $\tau$ von $10ms$ haben, und unsere Analyse der Rohdaten auf dem Oszilloskop ergeben hat das wir dort schon eine saubere abnahme haben, fanden wir dieses eine gute Annahme.
...
Während der Messung haben wir gemerkt, das bei so kleinen Spannungen an der rechten Intervallsgrenze, die Ablesegenauigkeit der Spannung groß wird,
und wir wengier Messfehler haben werden, wenn wir in einem kleineren Intervall messen.
...
\begin{table}[H]
        ...
        \begin{tabularx}{1.00\textwidth}{l X X X X}
            ...
            \midrule
            4. & 2. Endladen     & $t_1 = 400 \mu s$ & $U_1 = 6.76V$ & $(9.90 \pm 0.13)ms$ \\
            & Kondensator  & $t_2 = 31.2 ms $  & $U_2 = 320mV$ \\
            \bottomrule
            5. & 1. Aufladen     & $t_1 = 4.5 ms  $ & $U_1 = -4.08V$ & $(10.02 \pm 0.11)ms$ \\
...
\begin{figure}[H]
  ...
  \centering
\end{figure}
Wie in dem Plot zu sehen ist, ist die Standartabweichung auf $\tau$ durch unsren kleiner gewählten Messintervalle ab Messung 3 deutlich geringer geworden.
Das aufgrund der angabe von den Komponenten berechnete $\tau$ von $10ms$ liegt als immer innerhalb der Messungenauigkeiten.
Deshalb haben wir bei der weiteren Auswertung alle Messwerte berücksichtigt.
Der gewichtete Mittelwert ist: $\tau = (9.98 \pm 0.142)ms$.
