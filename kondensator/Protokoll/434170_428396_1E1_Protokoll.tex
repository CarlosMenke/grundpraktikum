...
\begin{table}[H]
    ...
    \begin{tabularx}{1\textwidth}{X X X X} % adjust width as needed
        \toprule
        \textbf{Messung} & \textbf{Mittelwert} & $\pmb{\bar{\sigma_{Ui}}}$ & \textbf{Gesamtfehler stat.} \\
        \midrule
        1 & 9.0V & 0.1mV & 3.8mV \\
...
\begin{table}[H]
    ...
    \begin{tabularx}{1\textwidth}{X X X X}
        \toprule
        \textbf{Messung} & \textbf{Mittelwert} & $\pmb{\bar{\sigma_{Ii}}}$ & \textbf{Gesamtfehler .stat} \\
        \midrule
...
Im folgenden Graphen sind die Spannungen und Stromwerte, mit Linarer Regression Aufgetragen. 
Im oberen Graphen Sind die Mittelwerte von Spannung und Strom gegeneinander Aufgetragen. Die grüne Gerade, ist die Anpassung einer Geraden an die Wertepaare.
...
\end{equation}
 ...
 \begin{figure}[H]
  ...
  \caption{Lineare Regression mitessungen}
  \centering
  \end{figure}
...
Das b stannt ebenfalls aus der Linearen Regression, und bezeichnet den U-Achsen Abschnitt unserer Anpassung. Dieses ist jedoch sehr klein, was zu erwarten war.
...
Hier können wir sehen, die Lineare Regression nun im Rahmen beinahe aller Messfehler liegt und keine Systematik vorliegt.
...
Bei einer guten Anpassung erwarten wir ein  $\frac{\chi^2}{ndof}$ von ungefähr 1. Unser Wert von 0.807 ist etwas kleiner, was darauf schließen lässt, dass wir unsere Fehler unterschätzt haben. 
...
%TODO : Erwähnen welches Programm wir benutzen
...
\end{equation}
Mit diesen verschobenen Werten haben wir jetzt erneut die Linare Regression durchgeführt.
...
Anschließen haben wir die systematischen Fehler quadratisch addiert, um den Gesamtsystematischen Fehler auf R zu erhalten.
