...
\begin{figure}[H]
  ...
  \centering
\end{figure}
Wie in dem Plot zu sehen ist, ist die Standartabweichung auf $\tau$ durch unser kleiner gewähltes Messintervall ab Messung 3 deutlich geringer geworden.
Das Aufgrund der angabe von den Komponenten berechnete $\tau$ von $10ms$ liegt als für alle Messungen, abgesehen von Messung 5, in der Abweichung des Messfehlers.
