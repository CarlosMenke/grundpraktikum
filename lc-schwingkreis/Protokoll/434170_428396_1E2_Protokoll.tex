...
Dies Erachteten wir als Sinnvoll da wir wissen, dass $ f \propto \frac{1}{LC}$ ist. 
...
Zuerst haben wir eine Spannung von $U_0 = 6.2V$ angelegt da bei diser Spannung die Maximale Stromstärke der Spule ( $2.5A$ ) nicht überschritten wird.
