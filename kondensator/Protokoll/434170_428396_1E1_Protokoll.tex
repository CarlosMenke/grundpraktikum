...
\begin{aufgabe}{Grundlagen}
  ...
  Formelzeichen. \\
    ...
    \begin{equation}
        ...
        = C\frac{dQ}{dt} R
    \end{equation}
    Dabei ist $U_0$ die an den Stromkreis angelegte Spannung. Der besteht in diesen Falle nur aus einem in Reihe geschalteten Kondensator und einem Wiederstand.
    ...
    Auch fällt auf, das immer $I(t)\propto e^{-t/\tau}$ gilt, und für den Auflade Vorgang auch $U_C(t) \propto e^{-t/\tau}$.
    ...
    \begin{equation}
        U_C(t) = U_0 (1 - e^{-\frac{t}{RC}}) + U_{off} \ Aufladevorgang
    \end{equation}
    \begin{equation}
        U_C(t) = U_0 e^{-\frac{t}{RC}} + U_{off} \ Entladevorgang
    \end{equation}
    \begin{equation}
        I(t) = I_0 e^{-\frac{t}{RC}} + I_{off} \ Auf / Entladevorgang
    \end{equation}
