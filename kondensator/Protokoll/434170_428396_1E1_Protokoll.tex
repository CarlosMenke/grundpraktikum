...
\begin{figure}[H]
    ...
    \centering
\end{figure}
Um die Randeffekte vom Schaltereffekte zu vernachlässigen haben wir die ersten 10 Messwerte nicht berücksichtigt.
Zudem sieht man, wie man am Ende nur noch Rauschen sieht, darum haben wir bis Messwert 1010 betrachtet.
Somit ist dies noch ausreichend groß genug um eine linare Regression auszuführen.
Hier einmal Beispielhaft die linarisierten Daten von einer Messreihe in dem Intervall, welches wir für alle daten verwendet haben.
\begin{figure}[H]
    \centering
...
Dabei haben wir insgesamt 8 Messungen durchführt, 4 Auflade Vorgänge und 4 Entlade Vorgänge.
...
zu bestimmen. Insgesamt werden wir dann 16 $\tau$ Werte haben.
