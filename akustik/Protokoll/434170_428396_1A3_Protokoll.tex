...
longitutionalen Welle, M die Masse, D der Durchmesser und E das E-Modul der Stange. Die Dichte ist gegeben als:
	\begin{equation}
...
\begin{figure}[H]
  ...
  \centering
    \subfloat[Sättigung vom Mikrophon am Anfang der Messung]{\includegraphics[width=0.5\textwidth]{plots/434170_428396_1A3__Kupfer_Messung_09_plot.pdf}}
    \subfloat[Viele Störgeräusche]{\includegraphics[width=0.5\textwidth]{plots/434170_428396_1A3_Alu_Messung_08_plot.pdf}}
\end{figure}
\begin{figure}[H]
  \centering
    \subfloat{\includegraphics[width=0.5\textwidth]{plots/434170_428396_1A3__Kupfer_Messung_09_fft.pdf}}
    \subfloat{\includegraphics[width=0.5\textwidth]{plots/434170_428396_1A3_Alu_Messung_08_fft.pdf}}
\end{figure}
...
Daraus ergibt sich:\\
 ...
 \begin{table}[H]
        \centering
        \begin{tabularx}{1.0\textwidth}{X X X} % adjust width as needed
            \toprule
