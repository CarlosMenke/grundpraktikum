...
In diesem fallen die umliegenden Punkte gleichstark ab, sodass wir hier $f_{1+} = 1054 Hz$ genommen haben.
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{plots/Schwebung_0cm_01_1_FFT_Maximum.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{plots/Schwebung_0cm_01_2_FFT_Maximum.pdf}
    \caption{Bestimmung des Maximums von $f_-$ in SK 1}
    \label{Schwebung_Maxima}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{plots/Schwebung_0cm_02_1_FFT_Maximum.pdf}
    \caption{Bestimmung des Maximums von $f_+$ in SK 2}
\end{figure}

Hier fallen die Frequenzen im höheren Bereich deutlich langsamer ab, sodass wir hier $f_{2-} = 1177 Hz$ genommen haben.
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{plots/Schwebung_0cm_02_2_FFT_Maximum.pdf}
    \caption{Bestimmung des Maximums von $f_-$ in SK 2}
    \label{Schwebung_Maxima}
\end{figure}
...
\begin{center}
$\Delta t_1$ = $-2.289 \quad 10^{-3}s \quad \pm $
\end{center}
\begin{center}
$\Delta t_2$ = $-2.031 \quad 10^{-3}s \quad \pm $
\end{center}
...
Hierbei ist die Ablesegenauigkeit der relevante Fehler auf diese größe, da wir bei CASSY davon ausgehen können, dass wir kein Digitalisierungsfehler auf die Zeit haben. Dieser ist: $\sigma_t = \frac{0.0002}{\sqrt{12}} = 6\cdot 10^{-5}s$  und für $t_1$ und $t_2$ gleich groß.
Somit ergibt sich für $\Delta t$
\begin{equation}
\Delta t = t_2 - t_1 =  (89\cdot 10^{-5} \pm 8\cdot10^{-5})s
\end{equation}
...
Verglichen mit $k_1 = (0.109 \pm 0.002) Hz$ aus der Schwebung liegt $k_g$ innerhalb der statistichen Abweichungen.
Bei $k_2 = (0.127 \pm 0.002) Hz$ aus der Schwebung liegt $k_g$ außerhalb der statistischen Abweichungen.
