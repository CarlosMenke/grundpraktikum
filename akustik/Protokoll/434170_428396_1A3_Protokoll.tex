...
\begin{figure}[H]
    \caption{Exemlpariche Messung für gute jedes Material und zugehörige Fouierspektren}
  \centering
...
\begin{figure}[H]
  \centering
  \subfloat[Spannungsverlauf der Messung mit Amplitude im gesättigten Bereich]{\includegraphics[width=0.5\textwidth]{plots/434170_428396_1A3_Kupfer_Einsp_Fehler_01_plot.pdf}\label{fig:f1}}
  \hfill
  \subfloat[FFT der Messung mit Amplitude im gesättigten Bereich]{\includegraphics[width=0.5\textwidth]{plots/434170_428396_1A3_Kupfer_Einsp_Fehler_01_fft.pdf}\label{fig:f2}}
  \caption{Anordnung zur Durchführung einer Messung}
\end{figure}
...
%TODO : Einfügen der messung Fehler 05 
