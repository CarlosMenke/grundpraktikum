...
def cassy_plot_clear_2(datei: str, x: str, y: str, datei_2: str, y_2: str, plotname, start, end):
    ...
    plt.plot(x[start:end], np.sin((T_1/50+x[start:end])/T_1*(np.pi*2))*5.98*np.exp((-1)*x[start:end]*149.43))
    plt.xlabel(xstr)
    plt.legend()
    plt.ylabel(ystr)
    plt.grid()
...
#cassy_plot_clear_2('../Messdaten/Schwebung_0cm_01.labx','t', 'U_B1', '../Messdaten/Schwebung_0cm_01.labx', 'U_A1', 'Schwebung_0cm_01_Denta_T', 55, 79 )
cassy_plot_clear_2('../Messdaten/Schwebung_0cm_01.labx','t', 'U_B1', '../Messdaten/Schwebung_0cm_01.labx', 'U_A1', 'Schwebung_0cm_01_Denta_T', 0, 300 )