...
Dies sind somit schon genung Messungen um anschließend Sinnvoll eine Linare Regression durchzuführen.
...
\begin{table}[H]
    ...
    \begin{tabularx}{1.0\textwidth}{X X X X X X}
       ...
       \bottomrule
    \end{tabularx}
    \caption{Maxima bei der Messung von der Stange}
\end{table}
...
\begin{table}[H]
    ...
    \end{tabularx}
    \caption{Maxima bei der Messung von der Stange und Gewicht}
\end{table}
