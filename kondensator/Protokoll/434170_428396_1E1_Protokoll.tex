...
\begin{figure}[H]
  \centering
    \includegraphics[width=0.9\textwidth]{plots/messung-aufladen-kondensator-02_offsets.pdf}
...
Hier einmal die Werte Graphisch dargestellt, welche wir zum bestimmen der Offsets genommen haben.
