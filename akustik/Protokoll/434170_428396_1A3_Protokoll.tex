...
%TODO : Einfügen der Tabelle in der alle Frequenzen der Materialien aufgelistet sind
 \begin{table}[H]
        \centering
        \begin{tabularx}{0.8\textwidth}{c c c c} % adjust width as needed
            \toprule
...
\begin{equation}
	\mu = \frac{1}{n}\sum_{n=1}^nx_i
\end{equation}

\begin{equation}
	s^2 = \frac{1}{n-1}\sum_{n=1}^n(\mu-x_i)^2
\end{equation}
...
Für die verschiedenen Stangen ergaben sich dann Folgende Mittelwerte und statistische Fehler.\\
 ...
 \begin{table}[H]
        ...
        \begin{tabularx}{0.8\textwidth}{X X X} % adjust width as needed
            ...
            \midrule
            Stahl 15 & 1726.55Hz & $\pm$0.088Hz \\
            Aluminium & 1673.51Hz & $\pm$0.17Hz \\
            Messing & 1166.22Hz & $\pm$0.052Hz \\
            Kuper & 1288.22Hz & $\pm$0.10Hz \\
            \bottomrule
        \end{tabularx}
        \label{tab:mytable}
    \end{table}
...
Somit haben wir den Messfehler auf alle Größen bestimmt und können somit das elastizitätsmodul berechnen. Hierbei müssen die Statistischen und die Systematischen Fehler getrennt fortgeplanzt werden.
