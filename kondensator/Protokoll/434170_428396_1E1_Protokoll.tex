...
\begin{table}[H]
        ...
        \begin{tabularx}{1\textwidth}{X X X X} % adjust width as needed
            \toprule
            \textbf{Messung} & \textbf{Mittelwert} & \textbf{statistische Fehler} & \textbf{gesamtfehler} \\
            \midrule
            50$\mu$s  & 0.1s & -- & -10V - 10V \\
            Messwerte& $\Rightarrow$ N = 2001& & -0.01A - 0.01A\\
            \bottomrule
        \end{tabularx}
        \caption{Mittelwerte mit ihren Fehlern}
        \label{tab:mytable}
    \end{table}
