...
\end{equation}
Wenn beide Schwingkreise angeregt werden, dann kann man zwischen gleichsinniger und gegensinniger Aufladung 
...
\begin{table}[H]
    ...
    \begin{tabularx}{1\textwidth}{X X X X} % adjust width as needed
        \toprule
        \textbf{Messung} & \textbf{Schwingkreis} & \textbf{Frequenz} & \textbf{stat. Fehler}\\
        \midrule
        1 & 1 & 1106 Hz \\
        \midrule
        1 & 2 & 1118 Hz \\
...
Hier ist so wie bei den Einzelschwingkreisen der Fehler auf die Fundamentalfrequenz die Ableseungenauigkeit. Diese kann aus Graphik \ref{Schwebung_Maxima} entnommen werden.

\subsubsection{Bestimmen der Eigenfrequenzen}

%TODO : Messunsicherheiten auf f+ und f- 
Als weitere interessante Frequenzen, haben wir in dem gekoppelten Schwingkreis, die Frequenz der Schwebung und die Grundfrequenzen der beiden Schwingkreise. 
