...
\begin{figure}[!tbp]
  \centering
  \subfloat[Flower one.]{\includegraphics[width=5cm,height=5cm,keepaspectratio]{Bilder/Materialien.jpeg}\label{fig:f1}}
  \hfill
  \subfloat[Flower two.]{\includegraphics[width=5cm,height=5cm,keepaspectratio]{Bilder/Materialien.jpeg}\label{fig:f2}}
  \caption{My flowers.}
\end{figure}
