...
Unsere Messergebnisse sind in der Tabelle \ref{tab:freq} zusammengefasst:
...
Bei 3 Messungen liegt der Erwartungswert zwar nicht innerhalb einer Standartabweichung, aber innerhalb von 3, weshalb wir ihn nicht als Ausreißer exkludiert haben.
...
\begin{table}[H]
        ...
        \begin{tabularx}{1\textwidth}{X X X X} % adjust width as needed
            ...
            \bottomrule
        \end{tabularx}
        \caption{gemessene Frequenz der Schwingkreise}
    \end{table}
